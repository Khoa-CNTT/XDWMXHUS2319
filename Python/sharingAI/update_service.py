...
class UpdateQueryProcessor:
    ...
    async def _Determine_endpoint_update_async(
        ...
        preprocess_prompt = PromptTemplate(
            ...
            - EndPoint liên quan đến sửa đăng bài như mạng xã hôi:
            -{base_url}/api/Post/update-post
            Giải thích: Endpoint này dùng để sửa 1 bài đăng của người dùng.
            ...
            "Scope": được phép null
            - EndPoint liên quan đến sửa bình luận như mạng xã hôi:
            -{base_url}/api/Comment/UpdateComment
            Giải thích: Endpoint này dùng để sửa 1 bình luận của người dùng.
            Các tham số cần thiết từ BE(params):
            "PostId":không được phép null
            "CommentId": được phép null
            "Content": được phép null
            - EndPoint liên quan đến sửa thông tin của người dùng hiện tại gồm sửa Tên,Ảnh đại diện,ảnh nền và bio:
            -{base_url}/api/UserProfile/upProfile
            Giải thích: Endpoint này dùng để sửa thông tin của người dùng hiện tại gồm sửa Tên,Ảnh đại diện,ảnh nền và bio.
            Các tham số cần thiết từ BE(params):
            "FullName": được phép null
            "ProfileImage": được phép null
            "BackgroundImage": được phép null   
            "Bio": được phép null
             - EndPoint liên quan đến sửa thông tin của người dùng hiện tại gồm số điện thoại người dùng,số điện thoại người thân và giới tính:
            -{base_url}/api/UserProfile/upInformation
            Giải thích: Endpoint này dùng để sửa thông tin của người dùng hiện tại.
            Các tham số cần thiết từ BE(params):
            "PhoneNumber": được phép null
            "PhoneRelativeNumber": được phép null  
            "Gender":  được phép null                   
            ...
            * Với `query_for_sql` luôn thêm từ sở hữu "của tôi" vào để câu mang ý nghĩa là người dùng đang cung cấp thông tin của chính họ.
            ...
            JSON:
            {{
                "query":người dùng muốn sửa post với nội dung xin chao ae,
                "endpoint":"https://localhost:7053/api/Post/update-post",
                "params": {{'PostId': 'null','Content': 'xin chao ae', 'Images': 'null', 'Video': 'null', 'Scope': 'null'}},
                "query_for_sql": "",
            ...
            **Ví dụ chi tiết:**
            **1. Sửa bài đăng**
            * **Câu hỏi:** "Sửa bài đăng của tôi thành nội dung 'Chào mọi người' và phạm vi công khai"
            * **Đầu ra:**
               {{
                "query": "Sửa bài đăng của tôi thành nội dung 'Chào mọi người' và phạm vi công khai",
                "endpoint": "https://localhost:7053/api/Post/update-post",
                "params": {{"PostId": "not null", "Content": "Chào mọi người", "Images": "null", "Video": "null", "Scope": "public"}},
                "query_for_sql": "",
                "missing_fields": ["PostId"]
               }}
            * **Câu hỏi:** "Sửa bài đăng mới nhất của tôi thành nội dung 'Hôm nay vui quá' với video abc.mp4"
            * **Đầu ra:**
               {{
                "query": "Sửa bài đăng mới nhất của tôi thành nội dung 'Hôm nay vui quá' với video abc.mp4",
                "endpoint": "https://localhost:7053/api/Post/update-post",
                "params": {{"PostId": "not null", "Content": "Hôm nay vui quá", "Images": "null", "Video": "abc.mp4", "Scope": "null"}},
                "query_for_sql": "bài đăng mới nhất của tôi",
                "missing_fields": ["PostId"]
               }}
            * **Câu hỏi (có lịch sử chat):**
            * **Lịch sử chat:** "Bạn muốn sửa bài đăng nào?" → Người dùng trả lời: "Bài đăng ID 123 thành nội dung 'Tìm bạn đi chung xe' và phạm vi bạn bè."
            * **Đầu ra:**
            {{
                "query": "Bài đăng ID 123 thành nội dung 'Tìm bạn đi chung xe' và phạm vi bạn bè",
                "endpoint": "https://localhost:7053/api/Post/update-post",
                "params": {{"PostId": "123", "Content": "Tìm bạn đi chung xe", "Images": "null", "Video": "null", "Scope": "friends"}},
                "query_for_sql": "",
                "missing_fields": []
            }}
            * **2. Sửa bình luận**
            * **Câu hỏi:** "Sửa bình luận của tôi trong bài đăng mới nhất thành 'Hài hước quá'"
            * **Đầu ra:**
            {{
            "query": "Sửa bình luận của tôi trong bài đăng mới nhất thành 'Hài hước quá'",
            "endpoint": "https://localhost:7053/api/Comment/UpdateComment",
            "params": {{"PostId": "not null", "CommentId": "not null", "Content": "Hài hước quá"}}
            "query_for_sql": "bình luận của tôi trong bài đăng mới nhất của tôi",
            "missing_fields": ["PostId", "CommentId"]
            }}
            * **Câu hỏi (có lịch sử chat):**
            * **Lịch sử chat:** "Bạn muốn sửa bình luận nào?" → Người dùng trả lời: "Bình luận trong bài đăng ID 789 thành 'Cảm ơn nhé'."
            * **Đầu ra:**
            {{
            "query": "Bình luận trong bài đăng ID 789 thành 'Cảm ơn nhé'",
            "endpoint": "https://localhost:7053/api/Comment/UpdateComment",
            "params": {{"PostId": "789", "CommentId": "not null", "Content": "Cảm ơn nhé"}}
            "query_for_sql": "",
            "missing_fields": ["CommentId"]
            }}
            * **Câu hỏi:** "Cập nhật số điện thoại của tôi thành 0123456789 và sdt người thân thành 094343432"
            * **Đầu ra:**
               {{
                 "query": "Cập nhật số điện thoại của tôi thành 0123456789 và sdt người thân thành 094343432",
                "endpoint": "https://localhost:7053/api/UserProfile/upInformation",
                "params": {{"PhoneNumber": "0123456789", "PhoneRelativeNumber": "094343432","Gender":null}},
                "query_for_sql": "",
                "missing_fields": []
               }}
             * **Câu hỏi:** "Cập nhật số điện thoại của tôi thành 0123456789 và giới tính là nam"
            * **Đầu ra:**
               {{
                 "query": "Cập nhật số điện thoại của tôi thành 0123456789 và sdt người thân thành 094343432",
                "endpoint": "https://localhost:7053/api/UserProfile/upInformation",
                "params": {{"PhoneNumber": "0123456789", "PhoneRelativeNumber": "null","Gender":"Nam"}},
                "query_for_sql": "",
                "missing_fields": []
               }}
            * **Câu hỏi:** "Cập nhật tên của tôi thành Nguyễn Văn A"
            * **Đầu ra:**
               {{
                "query": "Cập nhật tên của tôi thành Nguyễn Văn A",
                "endpoint": "https://localhost:7053/api/UserProfile/upProfile",
                "params": {{"FullName": "Nguyễn Văn A", "ProfileImage": "null", "BackgroundImage": "null", "Bio": "null"}},
                "query_for_sql": "",
                "missing_fields": []
               }}
            * **Câu hỏi (có lịch sử chat):**
            * **Lịch sử chat:** "Bạn muốn cập nhật thông tin nào?" → Người dùng trả lời: "Hình nền thành background.jpg."
            * **Đầu ra:**
            {{
            "query": "Hình nền thành background.jpg",
            "endpoint": "https://localhost:7053/api/UserProfile/upProfile",
            "params": {{"FullName": "null", "ProfileImage": "null", "BackgroundImage": "background.jpg", "Bio": "null"}},
            "query_for_sql": "",
            "missing_fields": []
            }}   
...
""",
    ...
    async def generate_answer_update_stream_async(
        self,
        query: str,
        user_id: str,
        conversation_id: str,
    ...
    async def _stream_create_response(
        ...
        **Các tham số còn thiếu**:
        {context}

        **Các Endpoint có sẵn và Tham số**:
        - **/api/Post/update-post**: Cập nhật một bài đăng.
        - Bắt buộc: `PostId` (bài đăng cần sửa), `Content` (nội dung bài đăng), `Scope` (phạm vi hiển thị, ví dụ: công khai/bạn bè).
        - Tùy chọn: `Images` (hình ảnh), `Video` (video).
        - **/api/Comment/UpdateComment**: Cập nhật một bình luận.
        - Bắt buộc: `PostId` (bài đăng chứa bình luận), `CommentId` (bình luận cần sửa), `Content` (nội dung bình luận).
        - **/api/UserProfile/upProfile**: Cập nhật thông tin hồ sơ người dùng.
        - Tùy chọn: `FullName` (tên đầy đủ), `ProfileImage` (ảnh đại diện), `BackgroundImage` (ảnh bìa), `Bio` (tiểu sử), `PhoneNumber` (số điện thoại), `PhoneRelativeNumber` (số điện thoại người thân).

        **Nhiệm vụ**:
        - Phân tích `question` và `context` (danh sách các tham số còn thiếu, ví dụ: ["PostId", "Content"]).
        ...
        - Không nhắc đến các thuật ngữ kỹ thuật như "PostId", "endpoint" hay "tham số". Thay vào đó, dùng các cụm từ như "bài đăng nào", "bạn muốn nói gì" hoặc "ai có thể xem".
        - Nếu câu hỏi ngụ ý một hành động cụ thể (ví dụ: sửa bài đăng, cập nhật hồ sơ), hãy điều chỉnh câu trả lời phù hợp với hành động đó.
        ...
        **Quy tắc**:
        ...
        - Nếu thiếu nhiều tham số, liệt kê chúng một cách tự nhiên (ví dụ: "Mình cần biết bạn muốn sửa bài đăng nào và muốn thay đổi nội dung gì").
        ...
        **Chuyển đổi tham số sang ngôn ngữ tự nhiên**:
        - `PostId`: "Bài đăng nào" hoặc "bài đăng bạn muốn sửa".
        - `CommentId`: "Bình luận nào" hoặc "bình luận bạn muốn sửa".
        - `Content`: "Bạn muốn nói gì" hoặc "nội dung mới của [bài đăng/bình luận]".
        - `Scope`: "Ai có thể xem bài đăng" (ví dụ: công khai, bạn bè).
        - `Images`: "Hình ảnh bạn muốn thêm hoặc thay đổi".
        - `Video`: "Video bạn muốn thêm hoặc thay đổi".
        - `FullName`: "Tên mới của bạn".
        - `ProfileImage`: "Ảnh đại diện mới".
        - `BackgroundImage`: "Ảnh bìa mới".
        - `Bio`: "Tiểu sử hoặc mô tả về bạn".
        - `PhoneNumber`: "Số điện thoại mới".
        - `PhoneRelativeNumber`: "Số điện thoại người thân".

        **Định dạng đầu ra**:
        Một câu trả lời bằng ngôn ngữ tự nhiên (văn bản thuần túy) yêu cầu cung cấp thông tin còn thiếu.

        **Ví dụ**:
        1. Câu hỏi: "Sửa bài đăng của tôi"
        Tham số thiếu: ["PostId", "Content", "Scope"]
        Đầu ra: "Hì, bạn muốn sửa bài đăng nào thế? 😊 Nội dung mới là gì, và bạn muốn ai xem bài đó (công khai hay chỉ bạn bè)?"
        2. Câu hỏi: "Cập nhật bình luận"
        Tham số thiếu: ["PostId", "CommentId", "Content"]
        Đầu ra: "Oke, bạn muốn sửa bình luận nào trong bài đăng nào? Và bạn muốn đổi nội dung thành gì nè? 😄"
        3. Câu hỏi: "Cập nhật hồ sơ của tôi"
        Tham số thiếu: ["FullName", "Bio"]
        Đầu ra: "Tuyệt! Bạn muốn đổi tên thành gì, và có muốn thêm chút mô tả về bản thân vào tiểu sử không? 😊"
        4. Câu hỏi: "Sửa bài đăng với nội dung mới"
        Tham số thiếu: ["PostId", "Scope"]
        Đầu ra: "Nội dung mới nghe hay đó! 😄 Bạn muốn sửa bài đăng nào, và ai sẽ được xem bài này (công khai hay chỉ bạn bè)?"
        5. Câu hỏi: "Cập nhật số điện thoại"
        Tham số thiếu: ["PhoneNumber"]
        Đầu ra: "Oke, bạn muốn cập nhật số điện thoại mới là gì nào? 😊"
